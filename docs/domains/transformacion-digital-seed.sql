...
-- Estado: Especificación de referencia — aplicable cuando se active TD en producción
--
-- Nota: Esta seed SQL asume que las tablas ya existen y están vacías
-- (o tiene cláusulas ON CONFLICT para idempotencia).
-- ============================================================
