...
export const dataVisibilityScenario: DemoScenario = {
  ...
  phases: [
    ...
    },
    {
      ...
      status:      'upcoming',
      duration:    'Semana 24',
      description: '~78% del AIMS documentado automáticamente desde T1-T11',
      tools: [
        { code: 'T12', name: 'ISO 42001', status: 'pending', output: 'AIMS auditable por certificadora externa' },
      ],
    },
    {
      id:          'handover',
