...
const _impl = {
   ...
   */
  async getAuthUserCompanyId(): Promise<string | undefined> {
  ...
  async updateAuthUser(attributes: { password?: string; data?: Record<string, unknown> }) {
...
const _service = makeAuditable(_impl, 'services.auth')
